...
All Rights Reserved. */
import{h as s}from"./fetch-error.js";import{f as l,h as m}from"./network-error.js";import{i as u}from"./company-permissions.js";const d=e=>{try{return btoa(e)}catch(r){throw new Error(`Failed to encode base64: ${r}`)}},y=e=>{try{return atob(e)}catch{return e}},c=e=>{if(!e||typeof e!="string")throw new Error("User ID must be a non-empty string");return d(e)},I=e=>!e||typeof e!="string"?e:y(e),p=e=>{if(!e)throw new Error("Invalid response: missing user data");return{id:e.id,email:e.email,firstName:e.firstname,lastName:e.lastname,jobTitle:e.job_title,telephone:e.telephone,status:e.status,role:e.role,isCompanyAdmin:u(e.role)}},h=`
...
`;async function N(e){const r=c(e);return await l(_,{variables:{id:r}}).then(t=>{var n,i,o;if((n=t.errors)!=null&&n.length)return s(t.errors);const a=(o=(i=t==null?void 0:t.data)==null?void 0:i.company)==null?void 0:o.user;return a?p(a):null}).catch(m)}const C=`
